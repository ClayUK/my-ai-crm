...
function AdCollapsibleHeaderActions({ jobId, adId, promptTextareaId, aspectSelectHeaderId, saveAdPromptAndReferences, generateAdImages }) {
    _s();
    const [pendingSave, startSave] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    const onSavePrompt = (e)=>{
        stopProp(e);
        const el = document.getElementById(promptTextareaId);
        const editedPrompt = el?.value ?? "";
        const fd = new FormData();
        fd.set("jobId", jobId);
        fd.set("adId", adId);
        fd.set("editedPrompt", editedPrompt);
        startSave(async ()=>{
            await saveAdPromptAndReferences(fd);
        });
    };
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                style: {
                    ...
                    background: "var(--surfaceElevated)",
                    color: "var(--foreground)",
                    opacity: pendingSave ? 0.65 : 1
                },
                children: pendingSave ? "Saving…" : "Save prompt"
            }, void 0, false, {
                fileName: "[project]/app/jobs/[id]/ad-collapsible-header-actions.tsx",
                lineNumber: 116,
                columnNumber: 13
...
_s(AdCollapsibleHeaderActions, "uMo0Z04keXpjEcE4ugrsRdW7CNA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"]
    ];
});
...
//# sourceMappingURL=_fd05fdd9._.js.map