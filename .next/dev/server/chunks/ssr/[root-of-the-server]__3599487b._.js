...
const $$RSC_SERVER_ACTION_0 = async function buildAdsFromClaude(formData) {
    ...
    const output = job.claudeOutput || "";
    const parsed = output ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claudeAds$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["extractJsonObject"])(output) : null;
    if (!parsed) {
        throw new Error("Claude output is not valid JSON. Re-run generation or paste JSON-only output.");
    }
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].ad.createMany({
        data: ads.map((ad, index)=>({
                jobId,
                adNumber: index + 1,
                title: ad.angle || `Ad ${index + 1}`,
                sourceBlock: JSON.stringify(ad, null, 2),
                editedPrompt: String(ad.editedPrompt || ad.scenePrompt || "").trim(),
                status: "ready"
            }))
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3599487b._.js.map