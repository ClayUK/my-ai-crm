...
function validateAds(parsed, requestedCount) {
    ...
    if (parsed.ads.length !== requestedCount) {
        throw new Error(`Claude returned ${parsed.ads.length} ads but ${requestedCount} were requested.`);
    }
    parsed.ads.forEach((ad, index)=>{
        ...
        for (const field of requiredFields){
            ...
            if (typeof value !== "string" || !value.trim()) {
                throw new Error(`Ad ${adNum} is missing required field: ${field}`);
            }
        }
    });
    return parsed.ads;
...
const $$RSC_SERVER_ACTION_0 = async function createJob(formData) {
    ...
    try {
        const parsed = extractJsonObject(claudeOutput);
        const ads = validateAds(parsed, requestedCount);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].ad.createMany({
            data: ads.map((ad, index)=>({
                    ...
                    editedPrompt: ad.editedPrompt || ad.scenePrompt || "",
                    status: "ready"
                }))
        });
...
//# sourceMappingURL=_fb801861._.js.map